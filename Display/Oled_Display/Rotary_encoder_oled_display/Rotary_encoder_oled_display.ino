...
void draw(void) {
 ...
 u8g.drawStr(0, 30, "Rotated");  // put string of display at position X, Y
  //u8g.drawStr(0, 50, "Hum: ");
  u8g.setPrintPos(60, 30);  // set position
  u8g.print(encoder0Pos);  // display temperature from DHT11
  u8g.drawStr(78, 30, "Steps ");
 // u8g.setPrintPos(44, 50);
//  u8g.print(encoder0Pos * 10);  // display humidity from DHT11
 // u8g.drawStr(65, 50, "% ");
}
